...
namespace AbpDemoForWeixinCloud.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpDemoForWeixinCloudDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpDemoForWeixinCloudEfCoreEntityExtensionMappings to extend the IdentityUser entity
